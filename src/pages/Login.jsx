...
import { Eye, EyeOff, Mail, Lock, User, Building2, ArrowRight, Shield, Star } from 'lucide-react';
import './Login.css';
...
const Login = () => {
  ...
  const testimonials = [
    {
      name: "Sanjar Karimov",
      role: "Mavsumiy ishchi",
      company: "Qishloq xo'jaligi",
      avatar: "🌾",
      rating: 5,
      text: "JobLink orqali 3 oy ichida 5 marta ish topdim. Platforma juda qulay!"
    },
    {
      name: "Agrotek Farm",
      role: "Ish beruvchi",
      ...
      avatar: "🏭",
      rating: 5,
      text: "Eng sifatli ishchilarni topish uchun eng yaxshi platforma."
    }
  ];
