  ...
  const employers = [
    {
      ...
      logo: "🌾",
      image:
        "https://images.unsplash.com/photo-1566383434817-99d723b3b2a7?w=400",
      description:
        "Yetakchi paxta va meva-sabzavot ishlab chiqaruvchi. Mavsumiy ishchilar uchun eng yaxshi sharoitlarni taqdim etamiz.",
    ...
    },
    {
      ...
      description:
        "Organik meva-sabzavot ishlab chiqarish bilan shug'ullanuvchi kompaniya. Ekologik toza mahsulotlar.",
    ...
    },
    {
      ...
      description:
        "Katta qurilish loyihalarini amalga oshiruvchi kompaniya. Mavsumiy qurilish ishlarida tajribali.",
    ...
    },
    {
      ...
      description:
        "O'zbekistonning tarixiy shaharlarida turizm xizmatlarini ko'rsatuvchi kompaniya.",
    ...
    },
    {
      ...
      description:
        "Katta tekstil ishlab chiqarish korxonasi. Mavsumiy buyurtmalarda ko'plab ishchilar bilan ishlaymiz.",
    ...
    },
    {
      ...
      description:
        "Milliy taomlar tayyorlash va restoran xizmatlarini ko'rsatuvchi kompaniya.",
        ...
        <div className="container">
          <div className="header-content">
            <div className="header-text">
              ...
              <p>
                O'zbekistonning eng yaxshi mavsumiy ish beruvchi kompaniyalari
                bilan tanishing
              </p>
            </div>
        ...
        <div className="employers-content">
          <aside className="employers-filters">
            <div className="filters-header">
              <h3>🎯 Filtrlar</h3>
              <button className="filter-clear">✕ Tozalash</button>
            </div>
            ...
            <div className="filter-summary">
              <span className="label">Natija:</span> {employers.length} ta
              kompaniya
            </div>
          </aside>
