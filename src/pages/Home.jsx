...
const Home = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault()
    window.location.href = `/seasonal-jobs?q=${encodeURIComponent(searchQuery)}&location=${encodeURIComponent(location)}`
  }

  const stats = [
    { number: '25,000+', label: 'Mavsumiy Ishchilar', icon: Users, color: 'var(--primary)' },
    { number: '5,000+', label: 'Fermer Xo\'jaliklari', icon: Briefcase, color: 'var(--feature-accent)' },
    { number: '150,000+', label: 'Muvaffaqiyatli Ish', icon: CheckCircle, color: 'var(--warning)' },
    { number: '95%', label: 'Mijoz Mamnunligi', icon: Heart, color: 'var(--error)' }
  ]
  ...
  const testimonials = [
    {
      ...
      role: 'Paxta Teruvchi',
      company: 'Surxon Agro',
      content: 'JobLink orqali 3 yildan beri mavsumiy ishlar topib kelaman. Eng yaxshi platforma!',
      avatar: '�‍🌾',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Eng ishonchli ishchilarni shu yerdan topaman. Barcha hujjatlar rasmiy!',
      avatar: '�‍💼',
      rating: 5,
      workers: '150+ ishchi',
      period: 'har mavsum'
    },
    {
      ...
      company: 'Build Pro',
      content: 'Professional muhit, vaqtida to\'lov va mukammal shartlar. Tavsiya qilaman!',
      avatar: '�‍♂️',
      rating: 5,
        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-badge">
              <Sparkles size={16} />
              O'zbekiston #1 Mavsumiy Ish Platformasi
            </div>
            ...
            <p className="hero-description">
              25,000+ mavsumiy ishchi va 5,000+ fermer xo'jalik o'rtasida ishonchli 
              aloqa. Professional mavsumiy ish imkoniyatlari va kafolatlangan to'lovlar.
            </p>
        ...
        <div className="container">
          ...
          <div className="categories-grid">
            {seasonalCategories.map((category, index) => (
              <Link key={index} to={`/seasonal-jobs?category=${category.name}`} className="category-card">
                <div className="category-header">
                  ...
                  <div className="category-season" style={{ color: category.color }}>
                    {category.season}
                  </div>
                </div>
      ...
      <section className="featured-jobs">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-description">
              Eng yaxshi fermer xo'jaliklari va kompaniyalardan yangi ish e'lonlari
            </p>
          ...
          <div className="jobs-grid">
            {featuredJobs.map((job) => (
              <Link key={job.id} to={`/job/${job.id}`} className={`job-card ${job.urgent ? 'urgent' : ''}`}>
                {job.urgent && (
                ...
                <div className="job-benefits">
                  {job.benefits.slice(0, 2).map((benefit, index) => (
                    <span key={index} className="job-benefit">{benefit}</span>
                  ))}
                  {job.benefits.length > 2 && (
                    <span className="job-benefit">+{job.benefits.length - 2}</span>
                  )}
                </div>
      ...
      <section className="testimonials">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-description">
              Minglab mavsumiy ishchi va fermer xo'jaliklari JobLink orqali muvaffaqiyat qozongan
            </p>
          </div>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <h2 className="cta-title">
              Mavsumiy ishingizni bugun boshlang
            </h2>
            <p className="cta-description">
              25,000+ ishchi va 5,000+ fermer xo'jaliklar orasida o'z o'rningizni toping.
              Kafolatlangan to'lovlar va professional xizmat.
            </p>
